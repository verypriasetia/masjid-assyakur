/* ==========================================================================
   COMBINED.JS - ENGINE SIGNAGE MASJID ASSYAKUR V2.6 (STABLE FIXED)
   ========================================================================== */
...
setInterval(() => {
    ...
    const jam = sekarang.getHours();     // FIX TOTAL: Bersih dari typo 'Clinical'
    const menit = sekarang.getMinutes(); // FIX TOTAL: Bersih dari typo 'Clinical'
    const detik = sekarang.getSeconds(); // FIX TOTAL: Bersih dari eror typo 'Bird'
...
function aktifkanModeStandbySholat() {
    ...
    // Pengaturan gambar standby menggunakan object-fit: contain agar proporsional
...
function bangunStrukturSlideAntrian() {
    ...
    // Siklus Gambar & Teks Berurutan Proporsional
...
// PERBAIKAN STRUKTUR TEKS: Rata kiri dan mempertahankan enter baris baru dari Google Sheets
